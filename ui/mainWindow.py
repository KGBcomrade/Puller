...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        leftPlotsLayout = QVBoxLayout()
        rightPlotsLayout = QVBoxLayout()
        xPlotFrame = QFrame()
        LPlotFrame = QFrame()
        shiftPlotFrame = QFrame()
        vcPlotFrame = QFrame()
        xPlotFrame.setFrameShape(QFrame.Shape.Panel)
        LPlotFrame.setFrameShape(QFrame.Shape.Panel)
        shiftPlotFrame.setFrameShape(QFrame.Shape.Panel)
        vcPlotFrame.setFrameShape(QFrame.Shape.Panel)
        xPlotLayout = QHBoxLayout()
        LPlotLayout = QHBoxLayout()
        shiftPlotLayout = QHBoxLayout()
        vcPlotLayout = QHBoxLayout()
        xPlotFrame.setLayout(xPlotLayout)
        LPlotFrame.setLayout(LPlotLayout)
        shiftPlotFrame.setLayout(shiftPlotLayout)
        vcPlotFrame.setLayout(vcPlotLayout)
        progressLayout.addLayout(progressBarLayout)
        progressLayout.addLayout(plotsLayout)
        plotsLayout.addLayout(leftPlotsLayout)
        plotsLayout.addLayout(rightPlotsLayout)
        leftPlotsLayout.addWidget(xPlotFrame)
        leftPlotsLayout.addWidget(LPlotFrame)
        rightPlotsLayout.addWidget(shiftPlotFrame)
        rightPlotsLayout.addWidget(vcPlotFrame)
        ...
        # shift plot
        self.shiftPlot = Plot(ylabel='shift, um')
        shiftPlotLayout.addWidget(self.shiftPlot)
